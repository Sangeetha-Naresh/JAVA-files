...
class Product
{
    ...
    void extractInfo(String str)
    {
        ...
        try 
        {
            //creating  a FileWriter object that creates a new file info.txt
            FileWriter myWriter = new FileWriter("info.txt");

            //Writing the country, code and serial to the file info.text
            myWriter.write("Country: "+country+", Code: "+code+", Serial: "+serial);

            //closing the filewiriter object
            myWriter.close();
