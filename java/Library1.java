...
class Book
{
    ...
    int year;
     ...
     //creating an array list of books which is static
    ...
    Book(String na,String au, String pub, int y)
    {
        ...
        //adding the name of the book  to the books list
        Books.add(na);
    }
    ...
    {
        System.out.println("All the books in library are: "+Books);
...
class Library1
{
       public static void main(String args[])
    {
       ...
       //printing the reader1 details and books taken
        ...
        System.out.println("--------------------------------------------------------");
        //calling the static function to print the names of all books;
        Book.printAllbooks();
